...
def profile():
	...
	ohlc=u.get_ohlc(u.get_instrument_by_symbol('NSE_EQ', 'YESBANK'), OHLCInterval.Minute_10, datetime.datetime.strptime('05/11/2018', '%d/%m/%Y').date(), datetime.datetime.strptime('08/11/2018', '%d/%m/%Y').date())
